...
def plot_internal_km(
    ...
    for g in groups:
        ...
        # ax.step(sf.index, sf[labels[g]], where='post', linewidth=3, color=colors[g])
...
for path in paths:
    ...
    plot_internal_km(
        ...
        save_path=f'{SAVE_DIR}/{RESULT_DIR}/ALL_{center_name}.svg',
        fontsiz=FONTSIZE,
    ...
    for _, row in subgroup_cutoffs.iterrows():
        ...
        plot_internal_km(
            ...
            labels=list(LABELS),
            plot_type='risk_group',
            save_path=f'{SAVE_DIR}/{RESULT_DIR}/{group_name}_{center_name}.svg',
            fontsiz=FONTSIZE,
            cutoff_time=CUTOFF_TIME,
            survival_state=survival_state
        )
