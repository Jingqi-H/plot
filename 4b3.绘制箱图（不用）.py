...
is_train = ''
# is_train = '_train'
cindex_csv = f'PLOTS/4.联合建模/cox_cindex{is_train}_matrix.csv'
save_path = f'PLOTS/4.联合建模/cox_cindex{is_train}_boxplot.svg'
color_excel = 'PLOTS/@source/color scheme (Covariate).xlsx'
...
# 读取配色表，假设格式：Covariate | Color
color_df = pd.read_excel(color_excel)
color_dict = dict(zip(color_df['Covariates'], color_df['Colors']))
