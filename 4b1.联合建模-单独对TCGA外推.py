...
def read_file(_file, _columns, rename_columns, cutoff_all):
...
# ---------- 读取临床数据 ----------
_columns = ['case_id', 'risk','Age', 'Gender', 'Location', 'Grade', 'Histo Type',
...
for center in files:
    ...
    _cox_df = read_file(_file, val_columns, rename_columns, cutoff_all)
