...
for path in paths:
    ...
    plot_tertile_km(
        ...
        save_path=f'{SAVE_DIR}/{RESULT_DIR}_tertile/ALL_{center_name}.svg',
        fontsiz=FONTSIZE,
    ...
    for _, row in subgroup_cutoffs.iterrows():
        ...
        if not subgroup_col in ['Pathological T stage', 'Pathological N stage', 'Stage']:
            continue
        ...
        plot_tertile_km(
            ...
            labels=list(LABELS),
            plot_type='risk_group',
            save_path=f'{SAVE_DIR}/{RESULT_DIR}_tertile/{group_name}_{center_name}.svg',
            fontsiz=FONTSIZE,
            cutoff_time=CUTOFF_TIME,
            survival_state=survival_state,
            legend=False,
