...
paths = glob.glob(f'results/moe_wsi/{RESULT_DIR}/summary_SXCH-Train_dfs*.csv') + \
        glob.glob(f'results/moe_wsi/{RESULT_DIR}/summary_SXCH-Val_dfs*.csv')
...
for path in paths:
    ...
    for risk_group in df_ALL['risk_group'].unique():
        ...
        plot_internal_km(
                ...
                save_path=f'{SAVE_DIR}/{RESULT_DIR}/Risk{risk_group}Chemo(ALL)_{center_name}.svg',
                fontsiz=FONTSIZE,
    ...
    #     if not subgroup_col in ['Pathological T stage', 'Pathological N stage', 'Metastasis', 'Stage']:
    #         continue
    ...
    #                 labels=['No Chemo', 'Chemo'],
    #                 plot_type='Chemotherapy',
    #                 save_path=f'{SAVE_DIR}/{RESULT_DIR}/Risk{risk_group}Chemo({group_name})_{center_name}.svg',
    #                 fontsiz=FONTSIZE,
    #                 cutoff_time=CUTOFF_TIME,
    #                 survival_state=survival_state
    #             )
