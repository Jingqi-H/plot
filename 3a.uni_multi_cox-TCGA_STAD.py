...
result_df = result_df[['case_id', 'risk', 'Age', 'Gender', 'Location', 'Grade', 'Histo Type',
...
covariates = ['risk', 'Age_1',
              'pM', 'pT_2', 'pT_3', 'pT_4', 'pN_1', 'pN_2', 'pN_3', #'Stage_2', 'Stage_3', 'Stage_4',
            #   'Grade_2', 'Location_2', 'Location_3', 'Location_4', 'HistologicalType_2', 'LaurenType_2', 'LaurenType_3', 
              ]
